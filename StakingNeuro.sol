...
contract NeuroStaking is Ownable {
    ...
    struct PoolInfo {
        ...
        uint256 allocPoint;       // How many allocation points assigned to this pool. NEUROs to distribute per block.
        uint256 lastRewardBlock;  // Last block number that NEUROs distribution occurs.
        uint256 accCakePerShare; // Accumulated NEUROs per share, times 1e12. See below.
    }
    ...
    // NEURO tokens created per block.
    ...
    uint256 public totalAllocPoint = 12000;
    // The block number when NEURO mining starts.
    uint256 public startBlock;
    // The block number when NEURO mining ends.
